...
(function () {
    ...
    const importBgImage = document.getElementById('importBgImage');
    ...
    const allSeatSizeSlider = document.getElementById('allSeatSizeSlider');
    const allSeatSizeValue = document.getElementById('allSeatSizeValue');
    ...
    const shapeColorLabel = document.getElementById('shapeColorLabel');
    ...
    let selectedTextGroup = null;
    let selectedText = null;
    let selectedTextRect = null;
    let selectedCirclePath = null;
    ...
    shapeWidthSlider.addEventListener('input', () => {
        ...
        if (path) {
            ...
            if (selectedRectPath && selectedRectPath._resizeHandle) {
                const handle = selectedRectPath._resizeHandle;
    ...
    function addRectResizeHandle(path) {
        ...
        handle.addEventListener('mousedown', (e) => {
            ...
            origPt = Object.assign({}, points[handleIdx]);
            origOppPt = Object.assign({}, points[anchorIdx]); // anchor is the fixed point
        ...
        function onMove(e) {
            ...
            const points = path._rectPoints;
            const anchorIdx = handle._anchorIdx;
            const handleIdx = handle._handleIdx;
    ...
    window.addEventListener('mousemove', (e) => {
        ...
        if (dragTarget && roleSelect.value === 'admin') {
            ...
            const circle = dragTarget.querySelector('circle[data-seat-id]');
            if (circle) {
    ...
    function makeDraggable(group) {
        group.addEventListener('mousedown', (e) => {
            ...
            const circle = group.querySelector('circle[data-seat-id]');
        ...
        designerSVG.addEventListener('click', (e) => {
          ...
          `;
                ...
                centerDot.addEventListener('mousedown', (e) => {
                    let dragStart = getSVGCoords(designerSVG, e.clientX, e.clientY);
