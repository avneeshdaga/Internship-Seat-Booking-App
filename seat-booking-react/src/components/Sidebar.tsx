...
const Sidebar: React.FC<SidebarProps> = ({ mode }) => {
      ...
      <aside className="sidebar">
        <div className="sidebar-content">
          ...
          <div className="tool-section">
            <h3>View Controls</h3>
            <div className="button-group">
              <button className="secondary-btn" onClick={handleZoomReset}>
                🔍 Zoom Reset
              </button>
              <button className="secondary-btn">🔍+ Zoom In</button>
              <button className="secondary-btn">🔍- Zoom Out</button>
            </div>
          </div>
  ...
  // User sidebar with seat count feature
  return (
    <aside className="sidebar">
      <div className="sidebar-content">
        {/* Seat Selection with Count Logic */}
        <div className="tool-section">
        ...
        <div className="tool-section">
          ...
          <div className="instructions">
            <div className="step">
              ...
              <span>Click "Set Seat Count"</span>
            </div>
            <div className="step">
